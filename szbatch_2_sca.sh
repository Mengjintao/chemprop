#!/bin/bash
#SBATCH --job-name=chembl     # create a short name for your job
...
time python train.py --gpu 0 --data_path $data  --features_path $feature --save_dir $model0 --dataset_type regression --split_type scaffold_balanced  --num_folds 5 --metric rmse  --epochs 90 --batch_size $batch_size --no_features_scaling  --ensemble_size 5 --init_lr 0.0001 --max_lr 0.001 --final_lr 0.0001 --pytorch_seed $seed  --ffn_num_layers $ffn_num_layers --hidden_size $hidden_size --ffn_hidden_size 7 --depth $depth --quiet > $name0 2>&1 & 

time python train.py --gpu 1 --data_path $data  --features_path $feature --save_dir $model1 --dataset_type regression --split_type scaffold_balanced  --num_folds 5 --metric rmse  --epochs 90 --batch_size $batch_size --no_features_scaling  --ensemble_size 5 --init_lr 0.0001 --max_lr 0.001 --final_lr 0.0001 --pytorch_seed $seed  --ffn_num_layers $ffn_num_layers --hidden_size $hidden_size --ffn_hidden_size 9 --depth $depth --quiet > $name1 2>&1 & 

time python train.py --gpu 2 --data_path $data  --features_path $feature --save_dir $model2 --dataset_type regression --split_type scaffold_balanced  --num_folds 5 --metric rmse  --epochs 90 --batch_size $batch_size --no_features_scaling  --ensemble_size 5 --init_lr 0.0001 --max_lr 0.001 --final_lr 0.0001 --pytorch_seed $seed  --ffn_num_layers $ffn_num_layers --hidden_size $hidden_size --ffn_hidden_size 11 --depth $depth --quiet > $name2 2>&1 & 
wait
